...
{$R *.fmx}
{********************************************************************************}
// Procedimento : WriteConfig - Salva as configuração do MQTT em arquivo .txt
// Recebe       : Nada
// Retorna      : Nada
{********************************************************************************}
...
{********************************************************************************}
// Procedimento : ReadConfig - Lê as configuração do MQTT em arquivo .txt
// Recebe       : Nada
// Retorna      : Nada
{********************************************************************************}
...
{********************************************************************************}
// Procedimento : DrawGraf - Desenha a área do gráfico onde será plotado os valores
...
{********************************************************************************}
// Procedimento : PlotSignal - Plota o gráfico em função do tempo dos sinais
...
{********************************************************************************}
// Função   : CriaJSON - Formata os dados para o padrão JSON
...
{********************************************************************************}
// Procedimento : btPublishClick - Habilita / Para publicações no broker MQTT -
...
{********************************************************************************}
// Procedimento : FormCreate - Configurações durante a inicialização do software
// Recebe       : Nada
// Retorna      : Nada
{********************************************************************************}
